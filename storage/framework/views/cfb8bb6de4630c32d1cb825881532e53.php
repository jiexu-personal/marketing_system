...
<div class="container" style="max-width: 600px;">
    <div class="card shadow border-0 p-4">
        <h3 class="mb-4">Edit Record #<?php echo e($activity->id); ?></h3>
        <form action="/marketing/<?php echo e($activity->id); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-3">
                ...
                <input type="number" step="0.01" name="new_opening_amount" class="form-control" value="<?php echo e($activity->grand_total_claim); ?>">
...
</html><?php /**PATH C:\xampp\htdocs\marketing-app\resources\views/edit.blade.php ENDPATH**/ ?>