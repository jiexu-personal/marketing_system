        ...
        <div class="table-responsive">
            <table class="table table-hover table-borderless align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="px-3 text-ios-gray">#<?php echo e($activity->id); ?></td>
                        <td><?php echo e(\Carbon\Carbon::parse($activity->apply_date)->format('M d')); ?></td>
                        <td class="text-ios-blue text-truncate" style="max-width: 90px;"><?php echo e($activity->salesman); ?></td>
                        <td class="fw-medium text-truncate" style="max-width: 100px;"><?php echo e($activity->outlet_name); ?></td>
                        <td class="text-ios-red text-end fw-bold"><?php echo e(number_format($activity->grand_total_claim, 2)); ?></td>
                        <td class="text-center px-3 text-nowrap">
                            <a href="/marketing/<?php echo e($activity->id); ?>/details" class="btn btn-sm btn-light border rounded-pill px-2 text-secondary" style="font-size: 0.75rem;">Details</a>
                            <a href="/marketing/<?php echo e($activity->id); ?>/edit" class="btn btn-sm btn-light border rounded-pill px-2 text-primary" style="font-size: 0.75rem;">Edit</a>
                        </td>
                    </tr>
...
</html><?php /**PATH C:\xampp\htdocs\marketing-app\resources\views/dashboard.blade.php ENDPATH**/ ?>